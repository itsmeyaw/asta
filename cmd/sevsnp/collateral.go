...
var (
	collateralCmd        = &cobra.Command{Use: "collateral", Short: "SEV-SNP verifier collateral operations"}
	refreshCollateralCmd = &cobra.Command{Use: "refresh", Short: "Refresh AMD Milan SEV-SNP collateral", RunE: func(*cobra.Command, []string) error {
