...
var collateralCmd = &cobra.Command{Use: "collateral", Short: "TPM verifier collateral operations"}
var refreshCollateralCmd = &cobra.Command{Use: "refresh", Short: "Refresh GCP TPM collateral", RunE: func(*cobra.Command, []string) error {
